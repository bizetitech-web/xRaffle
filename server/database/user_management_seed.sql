...
('79a386a6-207b-11f1-89b6-a4e078b831cc', 'org_admin', 'Organization administrator', 2),
('79a386a7-207b-11f1-89b6-a4e078b831cc', 'manager', 'Organization manager', 3),
...
('89a386a3-207b-11f1-89b6-a4e078b831cc', 'MANAGE_ORGANIZATIONS', 'admin', 'Create and update organizations'),
('89a386a4-207b-11f1-89b6-a4e078b831cc', 'VIEW_AUDIT_LOGS', 'admin', 'View audit log entries');

INSERT IGNORE INTO role_permissions (role_id, permission_id)
SELECT r.id, p.id
FROM roles r
JOIN permissions p ON p.name IN ('MANAGE_USERS', 'MANAGE_ROLES', 'MANAGE_ORGANIZATIONS', 'VIEW_AUDIT_LOGS')
WHERE r.name = 'super_admin';

INSERT IGNORE INTO role_permissions (role_id, permission_id)
SELECT r.id, p.id
FROM roles r
JOIN permissions p ON p.name IN ('MANAGE_USERS', 'MANAGE_ORGANIZATIONS', 'VIEW_AUDIT_LOGS')
